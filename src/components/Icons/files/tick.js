  ...
  return (
    ...
    >
      <g id='vuesax/bold/tick-circle'>
        <circle id='Ellipse 6' cx='12' cy='12.5' r='8' fill='white' />
        <g id='vuesax/bold/tick-circle_2'>
          <g id='tick-circle'>
            <path
              ...
              fill='url(#paint0_linear_1284_793)'
            />
          </g>
        </g>
      </g>
      <defs>
        ...
        >
          <stop stop-color='#515FA7' />
          <stop offset='1' stop-color='#5D91EC' />
        </linearGradient>
      </defs>
    </svg>
  );
